...
s3gof3r is written in Go and requires go 1.5 or later. It can be installed with `go get` to download and compile it from source. To install the command-line tool, `gof3r` set `GO15VENDOREXPERIMENT=1` in your environment:
    ...
    $ go get github.com/codeguard/s3gof3r/gof3r
    
To install just the package for use in other Go programs:

    $ go get github.com/codeguard/s3gof3r

### Release Binaries

To try the latest release of the gof3r command-line interface without installing go, download the statically-linked binary for your architecture from **[Github Releases](https://github.com/codeguard/s3gof3r/releases).**
...
**s3gof3r package:** See the [godocs](http://godoc.org/github.com/codeguard/s3gof3r) for api documentation.

**gof3r cli :**  [godoc](http://godoc.org/github.com/codeguard/s3gof3r/gof3r)
